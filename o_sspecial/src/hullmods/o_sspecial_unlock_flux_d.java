...
public class o_sspecial_unlock_flux_d extends BaseHullMod {

    public static final int FLUX_PER_OP = 10;
    ...
    public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
        stats.getFluxDissipation().modifyFlat(id, getValueIncrease(hullSize));
    }
