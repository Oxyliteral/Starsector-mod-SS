...
public class Settings_Mod {
    ...
    public static Object[][] Unlock_Panel_GetButtonParams() {
        ...
        return new Object[][]
        {
                { "(OP)Weapons", "o_sspecial_unlock_weapon_%d", 20, 0, "", null },
                { "(OP)Flux Cap.", "o_sspecial_unlock_flux_c_%d", 3, 0, "", null },
                { "(OP)Flux Vents", "o_sspecial_unlock_flux_d_%d", 3, 0, "", null },
                { "(OP)Logistics", "o_sspecial_unlock_logistic_%d", 4, 0, "", null },
                { "(SP)Max OP", "o_sspecial_unlock_op_%d", 4, 4, "o_sspecial_unlock_op_%d_hidden", new Object[] { "o_sspecial_unlock_op_%d", -1 }},
                { "(SP)Hull", "o_sspecial_unlock_hull_%d", 1, 4, "", new Object[] { "o_sspecial_unlock_op_%d", 3 } },
        };
    }
